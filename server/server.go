...
const (
	...
	APISyncTokenChainFromAddress string = "/api/sync-token-chain-from-address"
)
...
func (s *Server) RegisterRoutes() {
	...
	s.AddRoute(APISyncTokenChainFromAddress, "POST", s.AuthHandle(s.APISyncTokenChainFromAddress, s.ErrorFunc))
